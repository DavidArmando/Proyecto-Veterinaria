...
public class PanelDeletePet extends JPanel {
	private static final long serialVersionUID = 1L;
	private Image img;
	private JSpinner ingressId;

	public PanelDeletePet() {
	...
	public void initComponents() {
		...
		Controller.getInstance().setDeleteConsult(this);
		...
		JLabel title = new JLabel("Borrar Mascota", SwingConstants.CENTER);
		...
		ButtonPreferences(buttonIngress, "Borrar", 100, 50, Color.decode("#FFFFFF"), Color.decode("#000000"));
